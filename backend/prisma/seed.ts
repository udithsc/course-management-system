...
const SAMPLE_VIDEOS = [
  {
    ...
    description:
      'Overview of what we will cover in this course — HTML, CSS, JavaScript, and modern frameworks.',
    url: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4',
  },
  {
    title: 'HTML Fundamentals',
    description:
      'Learn the building blocks of every webpage: tags, attributes, semantic HTML5 elements.',
  ...
  },
  {
    ...
    description:
      'Variables, functions, DOM manipulation, events, and asynchronous JS (promises, async/await).',
...
async function main() {
  ...
  const existingCourse = await prisma.course.findUnique({
    where: { name: 'Complete Web Development Bootcamp' },
  });
  ...
  if (existingCourse) {
    ...
    course = await prisma.course.create({
      data: {
        ...
        description:
          'A comprehensive bootcamp covering modern web development from scratch. You will learn HTML, CSS, JavaScript, and build real-world projects. Perfect for beginners and those looking to level up their skills.',
    ...
    console.log(`Lessons created: ${SAMPLE_VIDEOS.length}`);
    ...
    await prisma.review.create({
      data: {
        ...
        rating: 5,
        comment:
          'Absolutely fantastic course! John explains everything so clearly. Highly recommended for any beginner!',
    ...
    await prisma.review.create({
      data: {
        ...
        rating: 4,
        comment:
          'Great content and well-structured. Would love even more advanced topics in a follow-up course.',
        time: new Date().toISOString(),
      },
    });
