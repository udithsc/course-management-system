...
function validateEnv() {
  cleanEnv(process.env, {
    ...
    BACKEND_URL: str({ default: 'http://localhost:3001', desc: 'Public URL of this API server' }),
    FRONTEND_URL: str({ default: 'http://localhost:3000', desc: 'Allowed frontend origin for CORS' }),
  });
}
