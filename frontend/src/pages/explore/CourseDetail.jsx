  ...
  if (!course) {
    return (
      <Box sx={{ p: 4 }}>
        ...
        <Button onClick={() => navigate('/explore')} startIcon={<ArrowBackIcon />} sx={{ mt: 2 }}>
          Back to Explore
        </Button>
      </Box>
    );
      ...
      >
        ...
        <Grid container spacing={5} alignItems="center">
          <Grid item xs={12} md={7}>
            ...
            <Typography
              variant="body1"
              sx={{ color: 'rgba(255,255,255,0.75)', mb: 2.5, lineHeight: 1.7 }}
            >
              {course.description}
            </Typography>
              ...
              >
                {imageSrc ? (
                  ...
                  <PlayCircleFilledWhiteIcon
                    sx={{ fontSize: 56, color: 'rgba(255,255,255,0.3)' }}
                  />
                )}
              </Box>
                  ...
                  <Box sx={{ flex: 1 }}>
                    {[5, 4, 3, 2, 1].map((star) => {
                      ...
                      return (
                        ...
                        >
                          <Typography variant="caption" color="text.secondary" sx={{ width: 8 }}>
                            {star}
                          </Typography>
              ...
              >
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 2 }}>
                  <Avatar
                    src={
                      course.author.image
                        ? `${import.meta.env.VITE_API_URL}/files/${course.author.image}`
                        : undefined
                    }
                    sx={{
                      width: 52,
