...
export default function Auth() {
  ...
  return (
    ...
    >
      ...
      <Container
        maxWidth="lg"
        sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1 }}
      >
        <Paper
          component={motion.div}
        ...
        >
          ...
          >
            <Box sx={{ zIndex: 1, textAlign: 'left', width: '100%' }}>
              ...
              <Typography variant="h6" sx={{ fontWeight: 300, opacity: 0.9, mt: 2 }}>
                Empowering education through seamless administration and immersive learning
                experiences.
              </Typography>
            </Box>
          ...
          >
            ...
            <Typography variant="body1" color="text.secondary" sx={{ mb: 4 }}>
              {isSignUp
                ? 'Enter your details to join us today.'
